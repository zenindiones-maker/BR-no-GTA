...
def main():
 ...
 typed_domain_schemas={"AgentSessionEvidence/v1","RoutingEvidence/v1","ContractEvidence/v1","CodePathEvidence/v1","FailureFingerprintEvidence/v1","IncidentEvidencePack/v1"}
 observed_schemas={str(((r.get("worker_result") or {}).get("domain_evidence") or {}).get("schema") or "") for r in receipts.values()}
 domain_typed=bool(observed_schemas & typed_domain_schemas)
