...
def main():
 ...
 def runner(*,spec,board,task_mapping,profiles):
  ...
  broker.submit_handoff(from_task_id="failure-fingerprint",to_task_id="evidence-fan-in",evidence_refs=[receipts["failure-fingerprint"]["task_result_ref"]],summary="Failure fingerprint TaskResultEnvelope handed to fan-in.")
  ...
  broker.submit_handoff(from_task_id="evidence-fan-in",to_task_id="semantic-necessity-boundary",evidence_refs=[receipts["evidence-fan-in"]["task_result_ref"]],summary="Fan-in TaskResultEnvelope handed to deterministic semantic boundary.")
 ...
 result=execute_hermes_mission_capability(authorization=auth,routing_decision=routing,spec=spec,upstream_root=ROOT/"integrations/hermes-agent",hermes_home=x.artifact_dir/"hermes-home",artifact_dir=x.artifact_dir,runner=runner,upstream_sha="9eca7f388f71755293343dddd6ec4d9111d68fc4")
