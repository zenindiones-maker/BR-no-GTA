...
def main():
 ...
 result=execute_hermes_mission_capability(authorization=auth,routing_decision=routing,spec=spec,upstream_root=ROOT/"integrations/hermes_agent",hermes_home=x.artifact_dir/"hermes-home",artifact_dir=x.artifact_dir,runner=runner,upstream_sha="9eca7f388f71755293343dddd6ec4d9111d68fc4")
