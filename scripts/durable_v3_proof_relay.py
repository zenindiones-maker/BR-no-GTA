...
def main():
 ...
 expected=policy.get("bootstrap_release_sha",policy.get("expected_workflow_sha"))
 if expected!=a.expected_workflow_sha:raise SystemExit("BOOTSTRAP_RELEASE_REF_DRIFT")
 ...
 receipt={"workflow":policy["workflow_path"],"bootstrap_ref":policy.get("bootstrap_release_ref",policy.get("bootstrap_ref")),
  "expected_workflow_sha":expected,"run_id":a.workflow_run_id,"github_api_version":policy.get("github_api_version","2022-11-28"),
  "result":"ACCEPTED"}
