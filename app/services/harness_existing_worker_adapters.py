...
from app.contracts.harness_specialized_worker_contracts import TaskExecutionEnvelope,FORBIDDEN_WORKER_AUTHORITY_FIELDS
...
class AgentOfficeWorkerAdapter:
 ...
 def normalize_evidence(self,e,r):
  if isinstance(r,dict) and set(r)&FORBIDDEN_WORKER_AUTHORITY_FIELDS:raise ValueError("WORKER_EVIDENCE_INVALID:AUTHORITY_FIELD")
