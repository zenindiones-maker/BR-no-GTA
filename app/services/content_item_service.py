...
def create_content_item(
    ...
    return {
        ...
        "verified_claims": list(script_spec.get("verified_claims") or []),
        "youtube_strategy": script_spec.get("youtube_strategy"),
        "editorial_evidence_refs": list(script_spec.get("editorial_evidence_refs") or []),
        "cta": script_spec["cta"],
