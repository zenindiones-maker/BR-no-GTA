...
def _native_records() -> tuple[CapabilityRecord, ...]:
    return (
        ...
        _record(
            ...
            requirements=("OmniRoute 3.8.50 ephemeral standard GitHub runner", "explicit provider/model route", "ZERO_COST_OPERATION"),
            maturity=UNPROVEN,
            availability=UNKNOWN,
            allowed_actions=("RESEARCH", "EDITORIAL", "EXECUTION", "DEVELOPMENT", "DECISION"),
            policy_tags=("ai", "provider", "opencode", "free", "zero-cost", "omniroute"),
