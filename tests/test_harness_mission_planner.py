...
def test_system_improvement_research_mutation_fails_closed():
    from app.services.harness_adaptive_planning_service import _mission_action_allowed
    assert not _mission_action_allowed(mission_class="SYSTEM_IMPROVEMENT", action="RESEARCH", risk_side_effect_class="BOUNDED_MUTATION")
    assert not _mission_action_allowed(mission_class="SYSTEM_IMPROVEMENT", action="DECISION", risk_side_effect_class="MUTATING")
    assert not _mission_action_allowed(mission_class="SYSTEM_IMPROVEMENT", action="EXECUTION", risk_side_effect_class="EXTERNAL_SIDE_EFFECT")
